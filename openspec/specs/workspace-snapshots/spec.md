# workspace-snapshots Specification

## Purpose
Preserve multiplexer workspace metadata before reboot and restore shell structure
with shared pause settings and manual agent resume guidance on tmux and psmux.
